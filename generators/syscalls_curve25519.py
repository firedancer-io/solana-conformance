import base64
import hashlib
import test_suite.vm_pb2 as pb
...
test_vectors_msm_invalid = [
    # https://github.com/anza-xyz/agave/blob/v2.0.3/programs/bpf_loader/src/syscalls/mod.rs#L1281-L1290
    {
        ...
        "points_len": MSM_LEN,
        "result_point_addr": HEAP_START,
        "cu_avail": MSM_CU_BASE(CURVE_EDWARDS) + (MSM_LEN-1) * MSM_CU_INCR(CURVE_EDWARDS),
    },
    {
        "heap_prefix": base64.b16decode(
            scalar_valid +
...
test_vectors_validate = (
    _into_key_data("val", test_vectors_validate)
)
