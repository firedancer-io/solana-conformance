...
_TXNCONTEXT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="log_messages_byte_limit",
            full_name="org.solana.sealevel.v1.TxnContext.log_messages_byte_limit",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="genesis_hash",
            full_name="org.solana.sealevel.v1.TxnContext.genesis_hash",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
