...
_INSTREFFECTS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="log",
            full_name="org.solana.sealevel.v1.InstrEffects.log",
            index=5,
            number=6,
            type=12,
            cpp_type=9,
