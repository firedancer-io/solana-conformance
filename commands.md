...
You can also pass in additional targets with --target or -t              and use --keep-passing or -k to only generate effects for test cases that match.
...
* `-i, --input-dir PATH`: Input directory containing InstrContext messages  [default: raw_instruction_context]
...
Run tests on a set of targets with a directory of InstrContext or InstrFixture messages.
